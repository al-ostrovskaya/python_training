...
class UntitledTestCase(unittest.TestCase):
    ...
    def add_contact(self, wd, contact, none_="'[none]'"):
        ...
        wd.find_element_by_xpath("//form[./input[@name='photo']]").click()
        #wd.find_element_by_xpath("//form[./input[@name='photo']]").clear()
        #wd.find_element_by_xpath("//form[./input[@name='photo']]").send_keys("C:\\fakepath\\_LICENSE.txt")
