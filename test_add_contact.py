...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.add_contact(wd, Contact(firstname="firstname", middlename="middlename", lastname="lastname",
    ...
    def add_contact(self, wd, contact, none_="'[none]'"):
        ...
        #wd.find_element_by_xpath("/html/body/div/div[4]/form/input[7]").click()
        #wd.find_element_by_xpath("/html/body/div/div[4]/form/input[7]").clear()
        #wd.find_element_by_xpath("/html/body/div/div[4]/form/input[7]").send_keys("https://ifab.se/wp-content/uploads/2019/12/Your_Logo-OUR-PRODUCTS.png")
