...
class UntitledTestCase(unittest.TestCase):
    ...
    def add_contact(self, wd, contact, none_="'[none]'"):
        ...
        #wd.find_element_by_xpath("//input[@type='file']").clear()
        #wd.find_element_by_xpath("//input[@type='file']").send_keys("https://ifab.se/wp-content/uploads/2019/12/Your_Logo-OUR-PRODUCTS.png")
